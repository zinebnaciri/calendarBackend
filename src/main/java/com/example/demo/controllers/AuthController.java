...
public class AuthController {
	...
	@Autowired
	UserModuleAssignmentService userModuleAssignmentService;
	@Autowired
	...
	public ResponseEntity<?> registerUser(@RequestBody SignupRequest signUpRequest) {
		...
		user.setFiliere(signUpRequest.getFiliere()); // Set filiere only if it is not null
	...
	@GetMapping("users/2")
	public List<User> getUsersWithRole2() {
		return userService.getUsersByRoleId(2);
	}
